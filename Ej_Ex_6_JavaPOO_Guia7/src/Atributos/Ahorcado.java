...
public class Ahorcado {
    ...
    private int cant_Oportunidades;

    public Ahorcado() {
    }

    public Ahorcado(String[] palabra, int cant_letras_Encontradas, int cant_Oportunidades) {
        this.palabra = palabra;
        this.cant_letras_Encontradas = cant_letras_Encontradas;
        this.cant_Oportunidades = cant_Oportunidades;
    }
    ...
    public int getCant_Oportunidades() {
        return cant_Oportunidades;
    }

    public void setCant_Oportunidades(int cant_Oportunidades) {
        this.cant_Oportunidades = cant_Oportunidades;
    }
