...
package guia.pkg08.ejercicio.pkg03.alumnosnotas;
 ...
 */
public class Guia08Ejercicio03AlumnosNotas {
    ...
    public static void main(String[] args) {
        ...
        3. Crear una clase llamada Alumno que mantenga información sobre las notas de distintos
           ...
           toda la información al usuario y ese Alumno se guarda en una lista de tipo Alumno y 
